window.config = {
  ...
  "convite": {
    "paletaCores": "Rosa clássico, rosa canela e marsala",
    "tema": "Elegante",
    "musica": "assets/music_1784739432332.mp3",
    "tipoAbertura": "curta",
  ...
  "assets": {
    "capa": "assets/cover_1784739432332.jpg",
    "cartao": "assets/cartao_chatgpt_1784739432332.jpg",
    "aberturaSlides": [
      "assets/slide1_1784739432332.mp4"
    ],
    "aberturaSlidesMeta": [
      {
        "filePath": "assets/slide1_1784739432332.mp4",
        "label": "Abertura (Vídeo)",
        "type": "video"
      }
    ],
    "folhaVazia": "assets/folha_vazia_1784739432332.jpg",
    "folhaPreenchida": "assets/folha_1784739432332.jpg",
    "musica": "assets/music_1784739432332.mp3",
    "fabric": {
      "saveTheDate": {
        "referencia": "",
  ...
  "botoes": [
    ...
    },
    {
      ...
      "conteudo": "assets/popup_manual_premium_1784739432332.jpg"
    },
    {
      "tipoAcao": "PopupHtml",
      "tipoVisual": "css",
  ...
  "briefing": {
    ...
    "buttonDecisions": {
      ...
      "manualResumo": "Chegue no horário: Sua presença pontual é muito importante para nós. Confirme sua presença pelo menos 15 dias antes do evento. Convidado não convida! Se você consumir bebida alcoólica, traga uma caixinha gelada. Tudo o que você precisar, peça ao garçom. Os doces e o bolo serão servidos depois dos parabéns; portanto, não mexa na mesa. Divirta-se bastante! Estamos ansiosos para celebrar este momento especial com você. Não vá embora sem me dar um abraço e comer um pedaço do bolo. Queremos compartilhar cada instante com você.",
      "presentesResumo": "Sandália sem salto ou tênis slip-on, tamanho 39. Bolsas pequenas ou médias. Produtos para cuidados corporais, como hidratante, óleo de banho e Bud Splash. Maquiagem. Roupas de dormir, tamanho plus size G2. Perfumes doces, florais ou cítricos suaves."
    }
  }
};
