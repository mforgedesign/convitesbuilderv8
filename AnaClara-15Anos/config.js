window.config = {
  ...
  "convite": {
    ...
    "musica": "assets/music_1785191234672.mp3",
    "tipoAbertura": "longa",
  ...
  "assets": {
    "capa": "assets/cover_1785191234672.jpg",
    "cartao": "",
    "aberturaSlides": [
      "assets/slide1_1785191234672.mp4",
      "assets/slide2_1785191234672.jpg",
      "assets/slide3_1785191234672.mp4",
      "assets/slide4_1785191234672.jpg"
    ],
    "aberturaSlidesMeta": [
      {
        "filePath": "assets/slide1_1785191234672.mp4",
        "label": "Abertura (Vídeo)",
        "type": "video"
      },
      {
        "filePath": "assets/slide2_1785191234672.jpg",
        "label": "Convite Especial",
        "type": "image"
      },
      {
        "filePath": "assets/slide3_1785191234672.mp4",
        "label": "Cena Temática",
        "type": "video"
      },
      {
        "filePath": "assets/slide4_1785191234672.jpg",
        "label": "Prepare-se",
        "type": "image"
      }
    ],
    "folhaVazia": "assets/folha_vazia_1785191234672.png",
    "folhaPreenchida": "assets/folha_1785191234672.jpg",
    "musica": "assets/music_1785191234672.mp3",
    "musicStartSec": 0,
    "musicEndSec": null,
    "fabric": {
  ...
  "botoes": [
    ...
    },
    {
      ...
      "conteudo": "<link\n  href=\"https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500;600&family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;1,400&display=swap\"\n  rel=\"stylesheet\"\n>\n\n<link\n  rel=\"stylesheet\"\n  href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css\"\n>\n\n<style>\n* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n\n.mc-wrap {\n  --verde-escuro: #123d2b;\n  --verde-medio: #286348;\n  --dourado-escuro: #805b16;\n  --dourado: #c89a35;\n  --dourado-claro: #f4d878;\n\n  position: relative;\n  isolation: isolate;\n  overflow: hidden;\n\n  width: 100%;\n  padding: 36px 18px 40px;\n\n  font-family: \"Cormorant Garamond\", serif;\n\n  /* Fundo verde-claro */\n  background-color: #eaf3ed !important;\n  background-image: linear-gradient(\n    160deg,\n    #f8fcf9 0%,\n    #e3efe7 48%,\n    #f2f8f4 100%\n  ) !important;\n}\n\n/* Moldura externa: somente o contorno dourado */\n.mc-wrap::before {\n  content: \"\";\n  position: absolute;\n  inset: 8px;\n  z-index: 0;\n\n  padding: 2px;\n  border-radius: 28px;\n  pointer-events: none;\n\n  background: linear-gradient(\n    120deg,\n    #6f4b0c 0%,\n    #c8952f 16%,\n    #fff0a2 32%,\n    #a16f18 48%,\n    #f1ce6b 68%,\n    #7a5310 84%,\n    #d8aa47 100%\n  );\n\n  -webkit-mask:\n    linear-gradient(#ffffff 0 0) content-box,\n    linear-gradient(#ffffff 0 0);\n\n  -webkit-mask-composite: xor;\n  mask-composite: exclude;\n\n  filter: drop-shadow(\n    0 1px 2px rgba(100, 70, 10, 0.25)\n  );\n}\n\n/* Cabeçalho */\n.mc-header {\n  position: relative;\n  z-index: 3;\n\n  margin-bottom: 10px;\n  text-align: center;\n}\n\n.mc-crown {\n  display: block;\n  margin-bottom: 7px;\n\n  color: var(--dourado);\n  font-size: 25px;\n\n  text-shadow:\n    0 1px 0 #fff0a5,\n    0 2px 3px rgba(100, 70, 15, 0.3);\n\n  animation: crownFloat 4s ease-in-out infinite;\n}\n\n@keyframes crownFloat {\n  0%,\n  100% {\n    transform: translateY(0);\n  }\n\n  50% {\n    transform: translateY(-5px);\n  }\n}\n\n.mc-header h2 {\n  margin-bottom: 5px;\n\n  color: var(--verde-escuro);\n  font-family: \"Cinzel\", serif;\n  font-size: 22px;\n  font-weight: 600;\n  letter-spacing: 0.15em;\n  text-transform: uppercase;\n}\n\n.mc-header p {\n  color: var(--verde-medio);\n  font-size: 14.5px;\n  font-style: italic;\n}\n\n.mc-sub {\n  position: relative;\n  z-index: 3;\n\n  margin-bottom: 24px;\n\n  color: var(--dourado-escuro);\n  font-family: \"Cinzel\", serif;\n  font-size: 11px;\n  letter-spacing: 0.12em;\n  text-align: center;\n  text-transform: uppercase;\n}\n\n.mc-sub::before,\n.mc-sub::after {\n  content: \"\";\n  display: inline-block;\n\n  width: 36px;\n  height: 1px;\n  margin: 0 9px;\n\n  vertical-align: middle;\n}\n\n.mc-sub::before {\n  background: linear-gradient(\n    to right,\n    transparent,\n    var(--dourado)\n  );\n}\n\n.mc-sub::after {\n  background: linear-gradient(\n    to left,\n    transparent,\n    var(--dourado)\n  );\n}\n\n/* Área dos cards */\n.mc-grid {\n  position: relative;\n  z-index: 3;\n\n  display: grid;\n  gap: 13px;\n}\n\n.mc-card {\n  position: relative;\n  overflow: hidden;\n\n  border-radius: 20px;\n\n  /* Interior branco, sem fundo dourado */\n  background-color: #ffffff !important;\n  background-image: linear-gradient(\n    145deg,\n    #ffffff 0%,\n    #f8fcf9 100%\n  ) !important;\n\n  box-shadow:\n    0 4px 17px rgba(18, 61, 43, 0.09),\n    inset 0 0 8px rgba(18, 61, 43, 0.025);\n\n  animation: mcFade 0.6s ease both;\n}\n\n/* Borda metálica dos cards */\n.mc-card::before {\n  content: \"\";\n  position: absolute;\n  inset: 0;\n  z-index: 0;\n\n  padding: 1.5px;\n  border-radius: 20px;\n  pointer-events: none;\n\n  background: linear-gradient(\n    125deg,\n    #73500f 0%,\n    #d4a33e 18%,\n    #fff0a1 34%,\n    #926516 50%,\n    #ebc65e 70%,\n    #795310 88%,\n    #d4a33e 100%\n  );\n\n  -webkit-mask:\n    linear-gradient(#ffffff 0 0) content-box,\n    linear-gradient(#ffffff 0 0);\n\n  -webkit-mask-composite: xor;\n  mask-composite: exclude;\n}\n\n/* Reflexo suave */\n.mc-card::after {\n  content: \"\";\n  position: absolute;\n  top: -80%;\n  left: -55%;\n  z-index: 1;\n\n  width: 25%;\n  height: 250%;\n\n  opacity: 0.18;\n  pointer-events: none;\n  transform: rotate(25deg);\n\n  background: linear-gradient(\n    to right,\n    transparent,\n    rgba(255, 255, 255, 0.9),\n    transparent\n  );\n\n  animation: goldShine 7s ease-in-out infinite;\n}\n\n@keyframes goldShine {\n  0%,\n  65% {\n    left: -55%;\n  }\n\n  85%,\n  100% {\n    left: 125%;\n  }\n}\n\n@keyframes mcFade {\n  from {\n    opacity: 0;\n    transform: translateY(11px);\n  }\n\n  to {\n    opacity: 1;\n    transform: translateY(0);\n  }\n}\n\n.mc-top {\n  position: relative;\n  z-index: 2;\n\n  display: flex;\n  align-items: flex-start;\n  gap: 13px;\n\n  padding: 16px;\n}\n\n.mc-icon {\n  display: flex;\n  flex-shrink: 0;\n  align-items: center;\n  justify-content: center;\n\n  width: 46px;\n  height: 46px;\n\n  border: 1px solid rgba(228, 185, 78, 0.75);\n  border-radius: 14px;\n\n  background: linear-gradient(\n    145deg,\n    #0e3524 0%,\n    #28694a 52%,\n    #123d2b 100%\n  );\n\n  color: #f3d578;\n  font-size: 18px;\n\n  box-shadow:\n    0 3px 11px rgba(18, 61, 43, 0.23),\n    inset 0 1px 2px rgba(255, 245, 190, 0.18);\n}\n\n.mc-title {\n  margin-bottom: 4px;\n\n  color: var(--dourado-escuro);\n  font-family: \"Cinzel\", serif;\n  font-size: 11.5px;\n  font-weight: 600;\n  letter-spacing: 0.12em;\n  text-transform: uppercase;\n}\n\n.mc-text {\n  color: #26372f;\n  font-size: 15px;\n  line-height: 1.58;\n}\n\n.mc-text strong {\n  color: var(--verde-escuro);\n  font-weight: 600;\n}\n\n/* Último card em destaque */\n.mc-card-special {\n  background-color: #f2f8f4 !important;\n  background-image: linear-gradient(\n    145deg,\n    #f8fcf9 0%,\n    #e7f1ea 100%\n  ) !important;\n}\n\n.mc-card-special .mc-title {\n  color: var(--verde-escuro);\n}\n\n.mc-card-special .mc-icon {\n  background: linear-gradient(\n    145deg,\n    #8b6218 0%,\n    #e1b94f 48%,\n    #9a6b18 100%\n  );\n\n  color: #ffffff;\n}\n\n/* Decorações do fundo */\n.mc-flower {\n  position: absolute;\n  z-index: 1;\n\n  color: rgba(18, 61, 43, 0.065);\n  pointer-events: none;\n}\n\n.mc-flower-one {\n  top: -32px;\n  left: -30px;\n\n  font-size: 150px;\n  transform: rotate(-15deg);\n}\n\n.mc-flower-two {\n  right: -24px;\n  bottom: -30px;\n\n  font-size: 125px;\n  transform: rotate(20deg);\n}\n\n.mc-leaf {\n  position: absolute;\n  z-index: 1;\n\n  color: rgba(18, 61, 43, 0.07);\n  font-size: 90px;\n  pointer-events: none;\n}\n\n.mc-leaf-one {\n  top: 43%;\n  left: -25px;\n\n  transform: rotate(-30deg);\n}\n\n.mc-star {\n  position: absolute;\n  z-index: 2;\n\n  color: rgba(172, 123, 28, 0.5);\n  font-size: 11px;\n\n  pointer-events: none;\n  animation: starAnim 3s ease-in-out infinite;\n}\n\n@keyframes starAnim {\n  0%,\n  100% {\n    opacity: 0;\n    transform: scale(0);\n  }\n\n  50% {\n    opacity: 1;\n    transform: scale(1);\n  }\n}\n\n@media (max-width: 420px) {\n  .mc-wrap {\n    padding: 31px 14px 35px;\n  }\n\n  .mc-header h2 {\n    font-size: 19px;\n    letter-spacing: 0.11em;\n  }\n\n  .mc-header p {\n    font-size: 13.5px;\n  }\n\n  .mc-sub {\n    font-size: 9.5px;\n  }\n\n  .mc-sub::before,\n  .mc-sub::after {\n    width: 22px;\n    margin: 0 5px;\n  }\n\n  .mc-top {\n    gap: 11px;\n    padding: 14px;\n  }\n\n  .mc-icon {\n    width: 43px;\n    height: 43px;\n  }\n\n  .mc-text {\n    font-size: 14.5px;\n  }\n}\n</style>\n\n<div class=\"mc-wrap\">\n\n  <!-- Decorações -->\n  <i class=\"fa-regular fa-sun mc-flower mc-flower-one\"></i>\n  <i class=\"fa-regular fa-sun mc-flower mc-flower-two\"></i>\n  <i class=\"fa-solid fa-leaf mc-leaf mc-leaf-one\"></i>\n\n  <span\n    class=\"mc-star\"\n    style=\"top: 8%; left: 9%; animation-delay: 0s;\"\n  >\n    ✦\n  </span>\n\n  <span\n    class=\"mc-star\"\n    style=\"top: 16%; right: 12%; animation-delay: 1.1s;\"\n  >\n    ✧\n  </span>\n\n  <span\n    class=\"mc-star\"\n    style=\"top: 42%; right: 7%; animation-delay: 1.6s;\"\n  >\n    ✦\n  </span>\n\n  <span\n    class=\"mc-star\"\n    style=\"bottom: 14%; left: 12%; animation-delay: 2s;\"\n  >\n    ✧\n  </span>\n\n  <span\n    class=\"mc-star\"\n    style=\"bottom: 6%; right: 11%; animation-delay: 0.6s;\"\n  >\n    ✦\n  </span>\n\n  <!-- Cabeçalho -->\n  <div class=\"mc-header\">\n    <span class=\"mc-crown\">\n      <i class=\"fa-solid fa-crown\"></i>\n    </span>\n\n    <h2>Manual do Convidado</h2>\n\n    <p>\n      Pequenos cuidados para tornar esta celebração\n      ainda mais especial\n    </p>\n  </div>\n\n  <div class=\"mc-sub\">\n    informações importantes\n  </div>\n\n  <div class=\"mc-grid\">\n\n    <!-- Cor verde -->\n    <div\n      class=\"mc-card\"\n      style=\"animation-delay: 0.04s;\"\n    >\n      <div class=\"mc-top\">\n\n        <div class=\"mc-icon\">\n          <i class=\"fa-solid fa-shirt\"></i>\n        </div>\n\n        <div>\n          <div class=\"mc-title\">\n            Cor reservada\n          </div>\n\n          <div class=\"mc-text\">\n            💚 Pedimos, com carinho, que não utilizem roupas\n            na cor verde, para preservar a identidade visual\n            da festa.\n          </div>\n        </div>\n\n      </div>\n    </div>\n\n    <!-- Fotografias -->\n    <div\n      class=\"mc-card\"\n      style=\"animation-delay: 0.10s;\"\n    >\n      <div class=\"mc-top\">\n\n        <div class=\"mc-icon\">\n          <i class=\"fa-solid fa-camera-retro\"></i>\n        </div>\n\n        <div>\n          <div class=\"mc-title\">\n            Registre cada momento\n          </div>\n\n          <div class=\"mc-text\">\n            📸 Tire muitas fotos e aproveite cada instante\n            dessa noite especial.\n          </div>\n        </div>\n\n      </div>\n    </div>\n\n    <!-- Diversão -->\n    <div\n      class=\"mc-card\"\n      style=\"animation-delay: 0.16s;\"\n    >\n      <div class=\"mc-top\">\n\n        <div class=\"mc-icon\">\n          <i class=\"fa-solid fa-music\"></i>\n        </div>\n\n        <div>\n          <div class=\"mc-title\">\n            Dance e divirta-se\n          </div>\n\n          <div class=\"mc-text\">\n            💃 Dance, sorria e divirta-se! Sua energia fará\n            essa celebração ainda mais inesquecível.\n          </div>\n        </div>\n\n      </div>\n    </div>\n\n    <!-- Agradecimento -->\n    <div\n      class=\"mc-card mc-card-special\"\n      style=\"animation-delay: 0.22s;\"\n    >\n      <div class=\"mc-top\">\n\n        <div class=\"mc-icon\">\n          <i class=\"fa-solid fa-heart\"></i>\n        </div>\n\n        <div>\n          <div class=\"mc-title\">\n            Minha gratidão\n          </div>\n\n          <div class=\"mc-text\">\n            💛 Obrigada por fazer parte do meu sonho e por\n            celebrar esse momento tão especial comigo!\n          </div>\n        </div>\n\n      </div>\n    </div>\n\n  </div>\n</div>"
    }
  ],
  "upsell": {
    "galeriaFotos": false,
